...
---
Code-switching, or the rapid alternation from one language to another, is of particular interest to linguists because bilinguals can rapidly code-switch without causing any difficulties in communication. Analyses of bilingual corpora (collections of spoken or written linguistic data) have highlighted that in Spanish-English code-switching, switching between certain **part of speech** categories (i.e., **determiner-noun**; _el flag_) is more common than others. Similarly, descriptive trends of Spanish-English code-switching have highlighted that broadly speaking, switching from **Spanish to English** (i.e., _el flag_) is more common than in the **opposite direction** (i.e., _the bandera_). However, these investigations have largely been based on solely the [Bangor Miami Corpus](https://bangortalk.org.uk/speakers.php?c=miami), leaving it unknown as to whether similar trends occur in corpora from **different regions** and/or **different modalities** (i.e., oral data).

The present study investigated whether Spanish-English bilinguals code-switched between similar parts of speech and in similar directions via **oral and written corpora** created in Texas and Florida. To accomplish this, we analyzed the following corpora:
